...
const General = () => {
  ...
  const { levels, referrals, withdrawallimit, shortcodemessage, planbasedon } = userData;
  ...
  const handleSubmit = (e) => {
    e.preventDefault(); 
    let finaldata={'setting_key':'general_settings','setting_value':JSON.stringify(userData)}
    ...
    <Adminlayout>
      <div className="container">
        ...
        <div className="w-full flex">
          <HeaderSettings />
          <div className="w-100">
            <form className="table-layout: auto w-full max-w-lg" onSubmit={handleSubmit}>
              ...
              <div className="md:flex md:items-center">
                ...
                <input type="submit"  className="shadow bg-gray-500  focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" value="submit" />
