...
const Licence = () => {
  ...
  useEffect(() => {
    const postdata = { setting_key: "licence_settings" };
          ...
          <div className="w-100">
            <div className="flex items-center justify-between flex-wrap bg-gray-500 p-2">
              <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-sm lg:flex-grow">
                  <h1 className={styles.header}>Licence</h1>
                </div>
              </div>
            </div>
            <br />
            ...
            >
              <div className="md:flex md:items-center mb-6">
                ...
                <button
                  class="bg-green-500 hover:bg-danger-700 text-white font-bold py-0 px-2 rounded focus:outline-none focus:shadow-outline"
                  type="button"
                >
                  Purchase Licence
                </button>
